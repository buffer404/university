...
HD_PWD='/home/leonid/Desktop/university/year3/DigitalCircuitry/lab3/lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_func.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_func.tcl -notrace
