...
HD_PWD='/home/leonid/Desktop/university/year3/DigitalCircuitry/lab3/lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_func.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_func.tcl
