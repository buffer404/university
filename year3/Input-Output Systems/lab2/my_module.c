...
#define SIZE_10M (10 * 2048)
#define SIZE_20M (20 * 2048)
#define SIZE_40M (40 * 2048)
...
{
	{
		...
		start_cyl: 0x0,
		part_type: 0x83,
		end_head: head4size(SIZE_10M - 1) + 1,
		end_sec: sec4size(SIZE_10M - 1),
		end_cyl: cyl4size(MEMSIZE - 1),
		abs_start_sec: 0x1,
		sec_in_part: SIZE_10M // 10Mbyte
	},
	{
		boot_type: 0x00,
		start_head: head4size(SIZE_10M),
		start_sec: sec4size(SIZE_10M) + 1,
		start_cyl: cyl4size(SIZE_10M),
		part_type: 0x05, // extended partition type
		end_head: head4size(SIZE_10M + SIZE_40M - 1) + 1,
		end_sec: sec4size(SIZE_10M + SIZE_40M - 1),
		end_cyl: cyl4size(MEMSIZE + SIZE_40M - 1),
		abs_start_sec: SIZE_10M + 1,
		sec_in_part: SIZE_40M
	}
};

static unsigned int def_log_part_br_abs_start_sector[] = {SIZE_10M + 1, SIZE_20M + SIZE_10M + 1, SIZE_20M + SIZE_20M + SIZE_10M + 1};
	...
	{
		{
			...
			start_cyl: 0x00, 
			part_type: 0x83,
			end_head: head4size(SIZE_20M - 1),
			end_sec: sec4size(SIZE_20M - 1),
			end_cyl: cyl4size(SIZE_20M - 1),
			abs_start_sec: 0x0,
			sec_in_part: SIZE_20M
		},
		{
			boot_type: 0x00,
			start_head: head4size(0xF000) + 1,
			start_sec: sec4size(SIZE_20M),
			start_cyl: cyl4size(SIZE_20M),
			part_type: 0x05,
			end_head: head4size(SIZE_20M + SIZE_20M - 1),
			end_sec: sec4size(SIZE_20M + SIZE_20M - 1),
			end_cyl: cyl4size(SIZE_20M + SIZE_20M - 1),
			abs_start_sec: SIZE_20M,
			sec_in_part: SIZE_20M + 1
		}
	},
	{
		{
