...
proc create_root_design { parentCell } {
  ...
  set dip_switches_16bits_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 dip_switches_16bits_0 ]
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO2 [get_bd_intf_ports dip_switches_16bits_0] [get_bd_intf_pins axi_gpio_0/GPIO2]
  ...
  connect_bd_net -net reset_inv_0_Res [get_bd_pins clk_wiz_1/reset] [get_bd_pins reset_inv_0/Res]
