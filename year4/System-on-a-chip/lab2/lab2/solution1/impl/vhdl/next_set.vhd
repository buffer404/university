...
architecture behav of next_set is 
    ...
    signal icmp_ln53_fu_137_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal j_fu_165_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal icmp_ln53_1_fu_159_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal add_ln61_fu_210_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln61_reg_269 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal sext_ln53_fu_143_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal sext_ln53_1_fu_154_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal sext_ln57_fu_177_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal sext_ln46_fu_200_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal sext_ln47_fu_205_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal add_ln53_fu_148_p2 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln53_1_fu_159_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln53_1_fu_159_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
                k_0_in_reg_86 <= ap_const_lv32_0;
            elsif (((icmp_ln57_fu_182_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln53_fu_137_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
                p_0_reg_118 <= ap_const_lv1_0;
            elsif (((icmp_ln60_fu_194_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state7))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln60_fu_194_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state7))) then
                add_ln61_reg_269 <= add_ln61_fu_210_p2;
                permutations_addr_3_reg_259 <= sext_ln46_fu_200_p1(3 - 1 downto 0);
                permutations_addr_4_reg_264 <= sext_ln47_fu_205_p1(3 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state4)) then
                ...
                permutations_addr_2_reg_243 <= sext_ln57_fu_177_p1(3 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln53_fu_137_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                permutations_addr_reg_219 <= sext_ln53_fu_143_p1(3 - 1 downto 0);
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state3, ap_CS_fsm_state2, icmp_ln53_fu_137_p2, icmp_ln53_1_fu_159_p2, ap_CS_fsm_state7, icmp_ln60_fu_194_p2, ap_CS_fsm_state5, icmp_ln57_fu_182_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state5 => 
                if (((icmp_ln57_fu_182_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state5))) then
            ...
            when ap_ST_fsm_state7 => 
                if (((icmp_ln60_fu_194_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state7))) then
                    ap_NS_fsm <= ap_ST_fsm_state10;
                else
    ...
    add_ln53_fu_148_p2 <= std_logic_vector(signed(i_assign_reg_74) + signed(ap_const_lv32_1));
    add_ln61_fu_210_p2 <= std_logic_vector(signed(r_reg_97) + signed(ap_const_lv32_FFFFFFFF));
    ...
    icmp_ln53_1_fu_159_p2 <= "1" when (signed(permutations_q0) < signed(permutations_q1)) else "0";
    icmp_ln53_fu_137_p2 <= "1" when (i_assign_reg_74 = ap_const_lv32_FFFFFFFF) else "0";
    icmp_ln57_fu_182_p2 <= "1" when (signed(reg_131) < signed(permutations_q0)) else "0";
    icmp_ln60_fu_194_p2 <= "1" when (signed(l_fu_188_p2) < signed(r_reg_97)) else "0";
    ...
    permutations_address0_assign_proc : process(ap_CS_fsm_state2, ap_CS_fsm_state4, permutations_addr_2_reg_243, ap_CS_fsm_state7, permutations_addr_4_reg_264, ap_CS_fsm_state6, ap_CS_fsm_state9, sext_ln53_fu_143_p1, sext_ln57_fu_177_p1, sext_ln47_fu_205_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state9)) then 
            permutations_address0 <= permutations_addr_4_reg_264;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state7)) then 
            permutations_address0 <= sext_ln47_fu_205_p1(3 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
            permutations_address0 <= permutations_addr_2_reg_243;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
            permutations_address0 <= sext_ln57_fu_177_p1(3 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            permutations_address0 <= sext_ln53_fu_143_p1(3 - 1 downto 0);
        else 
    ...
    permutations_address1_assign_proc : process(ap_CS_fsm_state8, permutations_addr_reg_219, ap_CS_fsm_state2, ap_CS_fsm_state7, permutations_addr_3_reg_259, ap_CS_fsm_state5, sext_ln53_1_fu_154_p1, sext_ln46_fu_200_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state8)) then 
            permutations_address1 <= permutations_addr_3_reg_259;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state7)) then 
            permutations_address1 <= sext_ln46_fu_200_p1(3 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
            permutations_address1 <= permutations_addr_reg_219;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            permutations_address1 <= sext_ln53_1_fu_154_p1(3 - 1 downto 0);
        else 
    ...
    permutations_we1_assign_proc : process(ap_CS_fsm_state8, ap_CS_fsm_state5, icmp_ln57_fu_182_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state8) or ((icmp_ln57_fu_182_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state5)))) then 
        ...
        sext_ln46_fu_200_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(l_fu_188_p2),64));

        sext_ln47_fu_205_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(r_reg_97),64));

        sext_ln53_1_fu_154_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(add_ln53_fu_148_p2),64));

        sext_ln53_fu_143_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(i_assign_reg_74),64));

        sext_ln57_fu_177_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(k_fu_171_p2),64));
