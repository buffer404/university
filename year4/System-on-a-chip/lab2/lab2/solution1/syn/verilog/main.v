...
wire   [0:0] icmp_ln80_fu_55_p2;
reg    grp_next_set_fu_44_ap_start_reg;
wire    ap_CS_fsm_state3;
wire    ap_CS_fsm_state4;
wire   [63:0] zext_ln81_fu_67_p1;
wire   [31:0] zext_ln80_fu_50_p1;
reg   [3:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln80_fu_55_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        permutations_address0 = zext_ln81_fu_67_p1;
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((icmp_ln80_fu_55_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
...
assign icmp_ln80_fu_55_p2 = ((i_0_i_i_reg_33 == 3'd7) ? 1'b1 : 1'b0);

assign zext_ln80_fu_50_p1 = i_0_i_i_reg_33;

assign zext_ln81_fu_67_p1 = i_0_i_i_reg_33;
