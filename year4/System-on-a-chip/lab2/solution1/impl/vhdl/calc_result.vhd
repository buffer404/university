...
architecture behav of calc_result is 
    ...
    "calc_result,hls_ip_2019_1,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7a100t-csg324-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=5.140000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=2,HLS_SYN_DSP=0,HLS_SYN_FF=288,HLS_SYN_LUT=566,HLS_VERSION=2019_1}";
    ...
    signal icmp_ln82_fu_55_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_next_set_fu_44_ap_start_reg : STD_LOGIC := '0';
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal zext_ln83_fu_67_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln82_fu_50_p1 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    component calc_result_permutations IS
    generic (
        DataWidth : INTEGER;
...
begin
    permutations_U : component calc_result_permutations
    generic map (
        DataWidth => 32,
        AddressRange => 7,
        AddressWidth => 3)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln82_fu_55_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state2, grp_next_set_fu_44_ap_done, grp_next_set_fu_44_ap_return, icmp_ln82_fu_55_p2, ap_CS_fsm_state4)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((icmp_ln82_fu_55_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
    ...
    icmp_ln82_fu_55_p2 <= "1" when (i_0_i_i_reg_33 = ap_const_lv3_7) else "0";

    permutations_address0_assign_proc : process(ap_CS_fsm_state2, grp_next_set_fu_44_permutations_address0, ap_CS_fsm_state4, zext_ln83_fu_67_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            permutations_address0 <= zext_ln83_fu_67_p1(3 - 1 downto 0);
    ...
    permutations_d0_assign_proc : process(ap_CS_fsm_state2, grp_next_set_fu_44_permutations_d0, ap_CS_fsm_state4, zext_ln82_fu_50_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    permutations_we0_assign_proc : process(ap_CS_fsm_state2, grp_next_set_fu_44_permutations_we0, icmp_ln82_fu_55_p2, ap_CS_fsm_state4)
    begin
        if (((icmp_ln82_fu_55_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    zext_ln82_fu_50_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_0_i_i_reg_33),32));
    zext_ln83_fu_67_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_0_i_i_reg_33),64));
end behav;
